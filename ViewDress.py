...
def ViewDress(): 
    ...
    headingLabel = Label(headingFrame1, text="View Available Dress ", bg='black', fg='white', font=('Courier',15))
    ...
    Label(labelFrame, text="{0:<7}{1:<51}{2:<25}{3:<25}{4:<25}\n".format('Code','Type','Category','Size','Price'),bg='black',fg='white').place(relx=0.07,rely=0.1)
    Label(labelFrame, text="-----------------------------------------------------------------------------------------------",bg='black',fg='white').place(relx=0.05,rely=0.2)

    getDress = "select * from dressTable"
    ...
    try:
        ...
        for i in cur:
            ...
            Label(labelFrame, text="{0:<7}{1:<51}{2:<25}{3:<25}{4:<25}\n".format(i[0],i[1],i[2],i[3],i[4]),bg='black',fg='white').place(relx=0.07,rely=y)
            y += 0.1
    except:
